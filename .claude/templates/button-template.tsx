...
const buttonVariants = cva(
  ...
  "font-sans inline-flex items-center justify-center whitespace-nowrap rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
      ...
      size: {
        sm: "h-8 px-4 text-sm",       // 32px height, 14px text
        default: "h-10 px-6 text-base",  // 40px height, 16px text (DEFAULT)
        lg: "h-12 px-8 text-base",    // 48px height, 16px text
        xl: "h-14 px-12 text-lg",     // 56px height, 18px text
